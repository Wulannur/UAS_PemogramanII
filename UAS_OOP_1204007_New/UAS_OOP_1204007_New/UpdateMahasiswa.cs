...
namespace UAS_OOP_1204007_New
{
    public partial class UpdateMahasiswa : Form
    {
        ...
        {
            string constr = "Data Source=DESKTOP-4TUI194;Initial Catalog=UAS;Integrated Security=True";
        ...
        private void UpdatePrd_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection myConnection = new SqlConnection(@"Data Source=DESKTOP-4TUI194;Initial Catalog=UAS;Integrated Security=True");
