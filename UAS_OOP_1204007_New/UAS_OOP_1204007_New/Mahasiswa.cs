...
namespace UAS_OOP_1204007_New
{
    public partial class Mahasiswa : Form
    {
        ...
        public Mahasiswa()
        {
            ...
            SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-4TUI194;Initial Catalog=UAS;Integrated Security=True");
        ...
        private void Mhs_KeyPress(object sender, KeyPressEventArgs e)
        {
